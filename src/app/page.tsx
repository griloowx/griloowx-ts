...
import logoMFM from '@/images/logos/mfmgroup.svg'
  ...
  return (
    <>
      <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
        ...
        <Button
          href="https://drive.google.com/file/d/1pi6Va9Slk2n_FPy3eHvupSbH9KyWbugJ/view?usp=drive_link"
          target="_blank"
          variant="secondary"
